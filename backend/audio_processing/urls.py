...
from .views import TrackSeparationView, GetOutputFilesView, GenerateSoundView, CheckQueueView, CleanupView
...
urlpatterns = [
    ...
    path('generate/', GenerateSoundView.as_view(), name='generate-sound'),  
